...
static void WindowTileInspectorInsertCorruptElement(int32_t elementIndex)
{
...
static void WindowTileInspectorClampCorrupt(int32_t elementIndex)
{
...
static void WindowTileInspectorMouseup(rct_window* w, rct_widgetindex widgetIndex)
{
    switch (widgetIndex)
    {
        ...
        case WIDX_BUTTON_CORRUPT:
            WindowTileInspectorInsertCorruptElement(windowTileInspectorSelectedIndex);
            break;
        ...
        case TILE_ELEMENT_TYPE_CORRUPT:
            switch (widgetIndex)
            {
                case WIDX_CORRUPT_BUTTON_CLAMP:
                    WindowTileInspectorClampCorrupt(windowTileInspectorSelectedIndex);
                    break;
            } // switch widget index
            break;
