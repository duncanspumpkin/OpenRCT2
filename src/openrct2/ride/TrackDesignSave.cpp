...
// *  rct2: 0x006CE44F
// */
// static TrackDesign* track_design_save_to_td6(ride_id_t rideIndex)
//{
//    TrackDesign* td6 = (TrackDesign*)calloc(1, sizeof(TrackDesign));
//    Ride* ride = get_ride(rideIndex);
//    td6->type = ride->type;
...
// *  rct2: 0x006CEAAE
// */
// static bool track_design_save_to_td6_for_maze(const Ride* ride, TrackDesign* td6)
//{
...
// *  rct2: 0x006CE68D
// */
// static bool track_design_save_to_td6_for_tracked_ride(const Ride* ride, TrackDesign* td6)
//{
