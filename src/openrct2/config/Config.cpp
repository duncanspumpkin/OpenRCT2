...
bool ConfigFindOrBrowseInstallDirectory()
{
    ...
    else
    {
        ...
        {
            uiContext->ShowMessageBox(FormatStringIDLegacy(STR_NEEDS_RCT2_FILES_MANUAL, nullptr));
            return false;
        }
        ...
        try
        {
            ...
            while (true)
            {
                uiContext->ShowMessageBox(FormatStringIDLegacy(STR_NEEDS_RCT2_FILES, nullptr));
                ...
                else if (chosenOption == gog)
                {
                    ...
                    {
                        uiContext->ShowMessageBox(FormatStringIDLegacy(STR_INSTALL_INNOEXTRACT, nullptr));
                        return false;
                    }
